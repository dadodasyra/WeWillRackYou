...
import { useKeyboardVisible } from "@/lib/keyboard-viewport";
...
export function BottomNav() {
  ...
  return (
    <nav
      className={`fixed bottom-0 left-0 right-0 z-50 border-t border-stone-200 bg-white/95 backdrop-blur safe-area-pb transition-[transform,opacity] duration-200 ${
